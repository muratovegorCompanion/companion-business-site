...
for (const file of [
  'styles.css','home.css','home.js','script.js','services.html','dms.html','app.html','logistyka.html',
...
console.log('Built static Companion site with pre-rendered homepage and standalone pages.');
